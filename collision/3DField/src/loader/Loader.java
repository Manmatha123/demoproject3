...
public class Loader {
    ...
    public RawModel loadToVAO(float[] positions, float[] textureCoordinates, float[] normals, int[] indices, Vector3f min, Vector3f max) {
        int vaoID = createVAO();
   ...
   public RawModel loadToVAO(float[] positions, int dimensions) {
    ...
    public RawModel loadToVAO(float[] positions, Vector3f min, Vector3f max) {
        ...
        unBindVAO();
        return new RawModel(vaoID, positions.length / 2,min,max);
    }
